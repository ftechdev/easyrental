  ...
  <div class="container">
    ...
    <div class="content">
      <div class="highlight-box">
        <p style="text-align: center; margin: 0;">Welcome to Al Ras Car and Bus Rental! Please verify your email address to complete your registration.</p>
      </div>
      
      <p class="info-text">Hello ${user.firstName},</p>
      <p class="info-text">Thank you for creating an account with Al Ras Car and Bus Rental. To get started, please verify your email address by clicking the button below:</p>
      ...
      <h2 style="color: #1e3c72; font-size: 18px; margin-top: 25px; margin-bottom: 15px; padding-bottom: 8px; border-bottom: 2px solid #f0f0f0;">
        Need Help?
      </h2>
      <p class="info-text">If you didn't create this account or need assistance, please contact our support team:</p>
